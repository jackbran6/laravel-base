...
1. Find and replace `ltw` with a short ~3 character project ID to represent the application name. (e.g "My awesome app" -> "maa", "formfunfunction" -> "fff").
...
5. Generate application key
    ```bash
    docker exec ltw-php php artisan key:generate
    ```
